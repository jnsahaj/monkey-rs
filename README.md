...
Inspired by Thorsten Ball's [interpreterbook.com](https://interpreterbook.com) where he writes an Interpreter using Go, for a modern programming language "monkey".
